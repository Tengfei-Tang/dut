...
;g=file_import('hl2a_24959_260_64_80_110_d8_tifit.nc')
g=file_import('EAST_daoyuan_85_105_260_64.nc')
...
filename="EAST_daoyuan_85_105_260_64.nc"
mu = 4.e-7*3.1415926
Ni_x=1.
Te_x= 10.
Ti_x= 10.
...
for i=jx,NX-1 do diff0[i] = diff0[jx+4]
...
for i=jx+4,NX-1 do chi_i[i,*] = chi_i[jx+3,*]
for i=jx+4,NX-1 do chi_e[i,*] = chi_e[jx+3,*]
for i=jx+4,NX-1 do diff[i,*] = diff[jx+3,*]
...
window,4
plot,diff[*,jy],chars=2,title='perpendicular transport coefficient D'
window,5
plot,chi_i[*,jy],chars=2,title='chi_i'
;oplot,chi0,color=2
window,6
plot,chi_e[*,jy],chars=2,title='chi_e'
;oplot,che0,color=2
